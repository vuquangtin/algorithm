...
public class Ackermann {
	 ...
	 * All primitive recursive functions are total and computable, but the Ackermann function illustrates 
	...
	private static BigInteger ackermann(BigInteger m, BigInteger n) {
		return m.equals(BigInteger.ZERO) ? n.add(BigInteger.ONE) : ackermann(
				m.subtract(BigInteger.ONE),
				n.equals(BigInteger.ZERO) ? BigInteger.ONE : ackermann(m,
