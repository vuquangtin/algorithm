 ...
 * 
 * The N-Queen puzzle is the problem of placing chess queens on a square chess
 * board so that no two queens threaten each other.
 * 
...
public class NQueens {
	...
	/**
	 * solves the N-Queen problem by moving forward column by column if safe and
	 * moving backward if not
	 * 
	 * @param board
	 *            2D board char array
	 * @param N
	 ...
	 * @param col
	 *            current column working on
	 * @return true if find a location to place Q at col; false if not or done
	 *         with placing all N Q's
	 */
