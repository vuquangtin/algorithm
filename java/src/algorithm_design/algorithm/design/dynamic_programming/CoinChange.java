package algorithm.design.dynamic_programming;

/**
 * The change-making problem addresses the following question: how can a given
 * amount of money be made with the least number of coins of given
 * denominations?
 * 
...
public class CoinChange {
	...
	private int helper(int[] coins, int rem, int[] count) {
		// rem: remaining coins after the last step; count[rem]: minimum number
		// of coins to sum up to rem
		if (rem < 0)
			return -1; // not valid
		if (rem == 0)
			return 0; // completed
