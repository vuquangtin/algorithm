...
public class DynamicArray<E> implements Iterable<E> {
	 ...
	 * 
	 * @param capacity
	 *            the starting length of the desired array
	 */
	 ...
	 * 
	 * @param element
	 *            the element of type <E> to be added to the array
	 */
	 ...
	 * 
	 * @param index
	 *            the index for the element to be placed
	 * @param element
	 ...
	 * 
	 * @param index
	 *            the desired index of the element
	...
	public String toString() {
		return Arrays.toString(Arrays.stream(this.elements)
