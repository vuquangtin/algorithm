...
/**
 * https://github.com/tonymontaro/java-algos/blob/master/src/CSES_FI/DP/
 * CoinCombinationsI.java
 * 
 ...
 *
 */
public class CoinCombinationsITempl {
	private static final int IO_BUFFERS = 128 * 1024;
	private static final FastReader in = new FastReader();
	private static final FastWriter out = new FastWriter();
	static ArrayList<Integer>[] adj;

	// https://github.com/tonymontaro/java-algos/blob/master/src/CSES_FI/DP/CoinCombinationsI.java
	...
	static class FastReader {
		...
		public ArrayList<Integer>[] adjacencyList(int n, int m)
				throws IOException {
