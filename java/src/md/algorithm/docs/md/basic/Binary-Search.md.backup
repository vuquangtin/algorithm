...
Ta sẽ dùng chỉ số của phần tử để đại diện cho các giá trị. Ban đầu, không gian tìm kiếm là từ 1
tới 11. Như tư tưởng của thuật toán, ta có giá trị trung bình, đó là 6 ( trung bình của 1 và 11 ) và nó nhỏ hơn 55. Từ đây chúng ta kết luận phần tử tại chỉ số 6 không phải là giá trị cần tìm, nhưng cũng không có phần tử nào có chỉ số từ 1 tới 5 có thể mang giá trị cần tìm , bởi vì giá trị tất cả các phần tử ở các chỉ số này nhỏ hơn 41. Từ đây ta có không gian tìm kiếm từ 7 tới 11:
...
Nếu **giá trị cần tìm** không có trong dãy, in ra −1

hoặc trả về là không tìm được.
...
Với mỗi so sánh, tìm kiếm nhị phân sử dụng hai nửa không gian tìm kiếm, nên ta có thể khẳng định rằng tìm kiếm nhị phân không bao giờ sử dụng nhiều hơn O(logN)

để tìm giá trị cần tìm.
