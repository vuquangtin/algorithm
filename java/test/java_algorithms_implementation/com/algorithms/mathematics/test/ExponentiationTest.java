package com.algorithms.mathematics.test;
...
import com.algorithms.mathematics.Exponentiation;
...
public class ExponentiationTest {
    ...
    public void recusriveExponentiationTest() {
        ...
        for (int i = 0; i < expectedResultList.size(); i++)
            assertEquals((Object)expectedResultList.get(i), Exponentiation.recursiveExponentiation(baseList.get(i), exponentList.get(i)));
    }
    ...
    public void fastRecusriveExponentiationTest() {
        ...
        for (int i = 0; i < expectedResultList.size(); i++)
            assertEquals((Object)expectedResultList.get(i), Exponentiation.fastRecursiveExponentiation(baseList.get(i), exponentList.get(i)));
    }
    ...
    public void fastRecusriveExponentiationModuloTest() {
        ...
        for (int i = 0; i < expectedResultList.size(); i++)
            assertEquals((Object)expectedResultList.get(i), Exponentiation.fastRecursiveExponentiationModulo(baseList.get(i), exponentList.get(i), divisorList.get(i)));
    }
}
